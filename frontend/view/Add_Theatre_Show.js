                ...
                <div class="card">
                    ...
                    <div class="card-body px-5">
                        <form>
                            ...
                            <p class="text-center text-muted mt-4 mb-0"><router-link :to="{name:'addshow'}" class="fw-bold" style="text-decoration: none;">Click here</router-link> to add a new show to this portal.</p>
                        </form>
                    </div>
                </div>
            </div>
